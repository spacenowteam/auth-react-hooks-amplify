...
import { userConfirmSignUp } from '../../context/services/auth';
...
const ConfirmSignUp = props => {
  ...
  const confirmSignUp = () => {
    userConfirmSignUp({ username: auth.user.username, code: _code })(dispatch)
  }
  ...
  return (
    ...
    <div className={`container`}>
      ...
      <div className="form-row">
        <div className="col">
          <button className={`btn btn-primary`} onClick={confirmSignUp}>
            Confirm
          </button>
        </div>
      </div>
